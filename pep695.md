...
- PEP 649 will provide a more complete basis for lazy evaluation
- Make it possible to evaluate lazy values using full PEP 649 semantics
- Make it so we don't have to materialize the function at import time?
